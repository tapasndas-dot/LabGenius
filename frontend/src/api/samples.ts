...
export type ReferenceDisplay = { id:string; code:string; name:string }
export type VersionReferenceDisplay = ReferenceDisplay & { version_number:number; status:string }
export type AssigneeDisplay = { id:string; display_name:string }
export type Sample = Dates & {
  ...
  material: ReferenceDisplay | null; specification_version: VersionReferenceDisplay | null;
  business_unit: ReferenceDisplay | null; division: ReferenceDisplay | null; department: ReferenceDisplay | null
}
export type SampleTest = Dates & { id: string; sample_id: string; specification_test_id: string; test_id: string; method_version_id: string | null; sequence_number: number; status: string; is_required: boolean; display_name: string | null; test:ReferenceDisplay|null; method_version:VersionReferenceDisplay|null; current_assignee:AssigneeDisplay|null }
